...
import { isArray, isEmpty, getDistance, translate } from 'utils';
                                        ...
                                        <TouchableOpacity style={tailwind('w-full')} onPress={toggleWaypointCollapse}>
                                            <View style={tailwind('px-3 py-2 w-full bg-yellow-400 border border-yellow-500 rounded shadow-sm flex')}>
                                                <View style={tailwind('flex flex-row')}>
                                                    ...
                                                    <Text style={[tailwind('font-bold text-yellow-900'), textStyle]}>{isWaypointsCollapsed ? translate('Order.Tap to expand') : translate('Order.Tap to collapse')}</Text>
                                                </View>
                                                <Text style={[tailwind('text-yellow-900'), textStyle]}>{middleWaypoints.length} {translate('Order.more waypoints')}</Text>
                                            </View>
                                        </TouchableOpacity>
                                    </View>
