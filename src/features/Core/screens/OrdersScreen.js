...
import { useDriver, useFleetbase, useMountedState, useResourceCollection, useLocale } from 'hooks';
    ...
    return (
        <View style={[tailwind('bg-gray-800 h-full')]}>
            <View style={tailwind('px-4 border-b border-gray-900')}>
                <View style={tailwind('bg-dark-purple rounded-xl shadow-sm border border-gray-800 mb-1 px-1')}>
                    <CalendarStrip
                        scrollable
                        ref={calendar}
                        ...
                        locale={locale === 'zh-TW' ? calLocaleZhTw : calLocaleEn}
                        key={locale}
                    />
                </View>
