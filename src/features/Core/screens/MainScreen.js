...
import { useDriver,useLocale, useMountedState } from 'hooks';
        ...
        <>
            <Tab.Navigator
                screenOptions={({ route }) => ({
                    ...
                    tabBarItemStyle: tailwind(`bg-purple border-gray-700 ${isAndroid ? 'py-1' : 'pt-1.5'}`),
                ...
                <Tab.Screen key="orders" name="Orders" component={OrdersStack} options={{
                    tabBarLabel: translate('Order.title')
                }}/>
                ...
                <Tab.Screen key="account" name="Account" component={AccountStack} options={{
                    tabBarLabel: translate('Account.title')
                }} />
            </Tab.Navigator>
        </>
    );
