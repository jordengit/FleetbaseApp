                    ...
                    <View style={tailwind('flex-1')}>
                        ...
                        {order.isNotStarted && !order.isCanceled && !isOrderPing && order.getAttribute('status') !== 'completed' && (
                            <TouchableOpacity style={tailwind('')} onPress={() => startOrder()}>
                                <View style={tailwind('btn bg-orange')}>
                                    {isLoadingAction && <ActivityIndicator color={getColorCode('text-green-50')} style={tailwind('mr-2')} />}
                                    <Text style={tailwind('font-semibold text-green-50 text-base')}>{translate('Order.OrderScreen.Start Order')}</Text>
                                </View>
                            </TouchableOpacity>
                        )}
                        {order.isInProgress && (
                            <TouchableOpacity style={tailwind('')} onPress={updateOrderActivity}>
                                <View style={tailwind('btn bg-green-900 border border-green-700')}>
                                    {isLoadingAction && <ActivityIndicator color={getColorCode('text-green-50')} style={tailwind('mr-2')} />}
                                    <Text style={tailwind('font-semibold text-green-50 text-base')}>{translate('Order.OrderScreen.Update Activity')}</Text>
                                </View>
                            </TouchableOpacity>
                        )}
                    </View>
                    ...
                    <View style={tailwind('bg-gray-800 ')}>
                                ...
                                <View style={tailwind('mb-4')}>
                                    <View style={tailwind('flex rounded-md bg-blue-900 border border-blue-700')}>
                                        <View style={tailwind('px-4 py-2 flex-1 border-b border-blue-700')}>
                                            <Text style={tailwind('font-bold text-white mb-1')}>{translate('Order.OrderScreen.Current Destination')}</Text>
                                        ...
                                        {waypointsInProgress.length > 0 && (
                                            <View style={tailwind('flex flex-row')}>
                                                <TouchableOpacity
                                                    ...
                                                    <Text style={tailwind('text-blue-50')}>{translate('Order.OrderScreen.Change')}</Text>
                                                </TouchableOpacity>
                                            </View>
                                        )}
                                    </View>
                            ...
                            <View style={tailwind('flex flex-col items-center')}>
                                <View style={tailwind('flex flex-row items-center justify-between w-full p-4 border-t border-b border-gray-700')}>
                                    <View style={tailwind('flex flex-row items-center')}>
                                        <Text style={tailwind('font-semibold text-gray-100')}>{translate('Order.OrderScreen.Customer.title')}</Text>
                                    </View>
                                </View>
                                <View style={tailwind('w-full p-4')}>
                                    {customer ? (
                                        ...
                                        <Text style={tailwind('text-gray-100')}>{translate('Order.OrderScreen.Customer.No Customer')}</Text>
                                    )}
                                </View>
                            </View>
                        </View>
                        <View style={tailwind('mt-2')}>
                            <View style={tailwind('flex flex-col items-center')}>
                                <View style={tailwind('flex flex-row items-center justify-between w-full p-4 border-t border-b border-gray-700 mb-1')}>
                                    <View style={tailwind('flex flex-row items-center')}>
                                        <Text style={tailwind('font-semibold text-gray-100')}>{translate('Order.OrderScreen.Details.title')}</Text>
                                    </View>
                                </View>
                                <View style={tailwind('w-full py-2')}>
                                    <View style={tailwind('flex flex-row items-center justify-between pb-1 px-3')}>
                                        <View style={tailwind('flex-1')}>
                                            <Text style={tailwind('text-gray-100')}>{translate('Order.OrderScreen.Details.Status')}</Text>
                                        </View>
                                    ...
                                    <View style={tailwind('flex flex-row items-center justify-between py-2 px-3')}>
                                        <View style={tailwind('flex-1')}>
                                            <Text style={tailwind('text-gray-100')}>{translate('Order.OrderScreen.Details.Internal ID')}</Text>
                                        </View>
                                        <View style={tailwind('flex-1 flex-col items-end')}>
                                    ...
                                    <View style={tailwind('flex flex-row items-center justify-between py-2 px-3')}>
                                        <View style={tailwind('flex-1')}>
                                            <Text style={tailwind('text-gray-100')}>{translate('Order.OrderScreen.Details.Order Type')}</Text>
                                        </View>
                                        <View style={tailwind('flex-1 flex-col items-end')}>
                                    ...
                                    <View style={tailwind('flex flex-row items-center justify-between py-2 px-3')}>
                                        <View style={tailwind('flex-1')}>
                                            <Text style={tailwind('text-gray-100')}>{translate('Order.OrderScreen.Details.Tracking Number')}</Text>
                                        </View>
                                        <View style={tailwind('flex-1 flex-col items-end')}>
                                    ...
                                    <View style={tailwind('flex flex-row items-center justify-between py-2 px-3')}>
                                        <View style={tailwind('flex-1')}>
                                            <Text style={tailwind('text-gray-100')}>{translate('Order.OrderScreen.Details.Date Created')}</Text>
                                        </View>
                                        <View style={tailwind('flex-1 flex-col items-end')}>
                                    ...
                                    <View style={tailwind('flex flex-row items-center justify-between py-2 px-3')}>
                                        <View style={tailwind('flex-1')}>
                                            <Text style={tailwind('text-gray-100')}>{translate('Order.OrderScreen.Details.Date Scheduled')}</Text>
                                        </View>
                                        <View style={tailwind('flex-1 flex-col items-end')}>
                                    ...
                                    <View style={tailwind('flex flex-row items-center justify-between py-2 px-3')}>
                                        <View style={tailwind('flex-1')}>
                                            <Text style={tailwind('text-gray-100')}>{translate('Order.OrderScreen.Details.Date Dispatched')}</Text>
                                        </View>
                                        <View style={tailwind('flex-1 flex-col items-end')}>
                                    ...
                                    <View style={tailwind('flex flex-row items-center justify-between py-2 px-3')}>
                                        <View style={tailwind('flex-1')}>
                                            <Text style={tailwind('text-gray-100')}>{translate('Order.OrderScreen.Details.Date Started')}</Text>
                                        </View>
                                        <View style={tailwind('flex-1 flex-col items-end')}>
                        ...
                        <View style={tailwind('mt-2')}>
                            <View style={tailwind('flex flex-col items-center')}>
                                <View style={tailwind('flex flex-row items-center justify-between w-full p-4 border-t border-b border-gray-700')}>
                                    <View style={tailwind('flex flex-row items-center')}>
                                        <Text style={tailwind('font-semibold text-gray-100')}>{translate('Order.OrderScreen.Notes')}</Text>
                                    </View>
                                </View>
                                <View style={tailwind('w-full p-4')}>
                        ...
                        {order.getAttribute('payload.entities', []).length > 0 && (
                            <View>
                                <View style={tailwind('flex flex-col items-center')}>
                                    <View style={tailwind('flex flex-row items-center justify-between w-full p-4 border-t border-b border-gray-700')}>
                                        <View style={tailwind('flex flex-row items-center')}>
                                            <Text style={tailwind('font-semibold text-gray-100')}>{translate('Order.OrderScreen.Payload.title')}</Text>
                                        </View>
                                    </View>
                                    <View>
                                                ...
                                                {order.getAttribute('payload.entities', []).map((entity, i) => (
                                                    <View key={i} style={tailwind('w-40')}>
                                                        <View style={tailwind('p-1')}>
                                                            <TouchableOpacity
                                                                onPress={() => navigation.push('EntityScreen', {
                                                                    _entity: entity,
                                                                    _order: order.serialize()
                                                                })}>
                                                                <View
                                                                    style={tailwind('flex items-center justify-center py-4 px-1 border border-gray-700 rounded-md')}>
                                                                    <FastImage source={{uri: entity.photo_url}} style={{
                                                                        width: 50,
                                                                        height: 50,
                                                                        marginBottom: 5
                                                                    }}/>
                                                                    <Text numberOfLines={1}
                                                                          style={tailwind('text-gray-100 font-semibold')}>
                                                                        {entity.name}
                                                                    </Text>
                                                                    <Text numberOfLines={1}
                        ...
                        <View style={tailwind('mt-2')}>
                            <View style={tailwind('flex flex-col items-center')}>
                                <View style={tailwind('flex flex-row items-center justify-between w-full p-4 border-t border-b border-gray-700')}>
                                    <View style={tailwind('flex flex-row items-center')}>
                                        <Text style={tailwind('font-semibold text-gray-100')}>{translate('Order.OrderScreen.Documents & Files')}</Text>
                                    </View>
                                </View>
                    ...
                    {actionSheetAction === 'update_activity' && (
                        <View style={tailwind('w-full h-full')}>
                            <View style={tailwind('px-5 py-2 flex flex-row items-center justify-between mb-4')}>
                                <View style={tailwind('flex flex-row items-center')}>
                                    <Text style={tailwind('text-lg font-semibold text-white')}>{translate('Order.OrderScreen.Activity.Confirm order activity')}</Text>
                                </View>
                                <View>
                                                ...
                                                <View key={index} style={tailwind('mb-4')}>
                                                    <TouchableOpacity
                                                        ...
                                                        <View style={tailwind('w-full flex flex-col items-start py-2')}>
                                                            <Text style={tailwind(`font-bold text-lg text-${getStatusColors(activity.code).color}-50`)}>{translate(`Order.OrderScreen.Activity.${activity.status}`)}</Text>
                                                            <Text style={tailwind(`text-${getStatusColors(activity.code).color}-100`)}>{translate(`Order.OrderScreen.Activity.${activity.details}`)}</Text>
                        ...
                        <View style={tailwind('w-full h-full')}>
                            <View style={tailwind('px-5 py-2 flex flex-row items-center justify-between mb-2')}>
                                <View style={tailwind('flex flex-row items-center')}>
                                    ...
                                    <Text style={tailwind('text-lg font-semibold text-white')}>{translate('Order.OrderScreen.Change destination waypoint')}</Text>
                                </View>
                                <View>
