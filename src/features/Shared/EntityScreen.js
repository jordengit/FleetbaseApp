                    ...
                    <View style={tailwind('bg-gray-800')}>
                            ...
                            <View style={tailwind('flex flex-col items-center')}>
                                <View style={tailwind('flex flex-row items-center justify-between w-full p-4 border-t border-b border-gray-700')}>
                                    <View style={tailwind('flex flex-row items-center')}>
                                        <Text style={tailwind('font-semibold text-gray-100')}>{translate('Order.OrderScreen.Payload.Customer.title')}</Text>
                                    </View>
                                </View>
                                <View style={tailwind('w-full p-4')}>
                                    {customer ? (
                                        ...
                                        <Text style={tailwind('text-gray-100')}>{translate('Order.OrderScreen.Payload.Customer.No Customer')}</Text>
                                    )}
                                </View>
                            </View>
                        </View>
                        <View style={tailwind('mt-2')}>
                            <View style={tailwind('flex flex-col items-center')}>
                                <View style={tailwind('flex flex-row items-center justify-between w-full p-4 border-t border-b border-gray-700 mb-1')}>
                                    <View style={tailwind('flex flex-row items-center')}>
                                        <Text style={tailwind('font-semibold text-gray-100')}>{translate('Order.OrderScreen.Payload.Details.title')}</Text>
                                    </View>
                                </View>
                                <View style={tailwind('w-full py-2')}>
                                    <View style={tailwind('flex flex-row items-center justify-between pb-1 px-3')}>
                                        <View style={tailwind('flex-1')}>
                                            <Text style={tailwind('text-gray-100')}>{translate('Order.OrderScreen.Payload.Details.Tracking Number')}</Text>
                                        </View>
                                    ...
                                    <View style={tailwind('flex flex-row items-center justify-between py-2 px-3')}>
                                        <View style={tailwind('flex-1')}>
                                            <Text style={tailwind('text-gray-100')}>{translate('Order.OrderScreen.Payload.Details.Status')}</Text>
                                        </View>
                                        <View style={tailwind('flex-1 flex-col items-end')}>
                                    ...
                                    <View style={tailwind('flex flex-row items-center justify-between py-2 px-3')}>
                                        <View style={tailwind('flex-1')}>
                                            <Text style={tailwind('text-gray-100')}>{translate('Order.OrderScreen.Payload.Details.Internal ID')}</Text>
                                        </View>
                                        <View style={tailwind('flex-1 flex-col items-end')}>
                                    ...
                                    <View style={tailwind('flex flex-row items-center justify-between py-2 px-3')}>
                                        <View style={tailwind('flex-1')}>
                                            <Text style={tailwind('text-gray-100')}>{translate('Order.OrderScreen.Payload.Details.Type')}</Text>
                                        </View>
                                        <View style={tailwind('flex-1 flex-col items-end')}>
                                    ...
                                    <View style={tailwind('flex flex-row items-center justify-between py-2 px-3')}>
                                        <View style={tailwind('flex-1')}>
                                            <Text style={tailwind('text-gray-100')}>{translate('Order.OrderScreen.Payload.Details.Weight')}</Text>
                                        </View>
                                        <View style={tailwind('flex-1 flex-col items-end')}>
                                    ...
                                    <View style={tailwind('flex flex-row items-center justify-between py-2 px-3')}>
                                        <View style={tailwind('flex-1')}>
                                            <Text style={tailwind('text-gray-100')}>{translate('Order.OrderScreen.Payload.Details.Dimensions')} (L x W x H)</Text>
                                        </View>
                                        <View style={tailwind('flex-1 flex-col items-end')}>
                                            <Text style={tailwind('text-gray-100')}>
                                    ...
                                    <View style={tailwind('flex flex-row items-center justify-between py-2 px-3')}>
                                        <View style={tailwind('flex-1')}>
                                            <Text style={tailwind('text-gray-100')}>{translate('Order.OrderScreen.Payload.Details.Date Created')}</Text>
                                        </View>
                                        <View style={tailwind('flex-1 flex-col items-end')}>
                        ...
                        <View style={tailwind('mt-2')}>
                            <View style={tailwind('flex flex-col items-center')}>
                                <View style={tailwind('flex flex-row items-center justify-between w-full p-4 border-t border-b border-gray-700 mb-1')}>
                                    <View style={tailwind('flex flex-row items-center')}>
                                        <Text style={tailwind('font-semibold text-gray-100')}>{translate('Order.OrderScreen.Payload.Details.Value')}</Text>
                                    </View>
                                </View>
                                <View style={tailwind('w-full py-2')}>
                                    <View style={tailwind('flex flex-row items-center justify-between pb-1 px-3')}>
                                        <View style={tailwind('flex-1')}>
                                            <Text style={tailwind('text-gray-100')}>{translate('Order.OrderScreen.Payload.Details.Price')}</Text>
                                        </View>
                                        <View style={tailwind('flex-1 flex-col items-end')}>
                                    ...
                                    <View style={tailwind('flex flex-row items-center justify-between py-2 px-3')}>
                                        <View style={tailwind('flex-1')}>
                                            <Text style={tailwind('text-gray-100')}>{translate('Order.OrderScreen.Payload.Details.Sales Price')}</Text>
                                        </View>
                                        <View style={tailwind('flex-1 flex-col items-end')}>
                                    ...
                                    <View style={tailwind('flex flex-row items-center justify-between py-2 px-3')}>
                                        <View style={tailwind('flex-1')}>
                                            <Text style={tailwind('text-gray-100')}>{translate('Order.OrderScreen.Payload.Details.Declared Value')}</Text>
                                        </View>
                                        <View style={tailwind('flex-1 flex-col items-end')}>
                                            <Text style={tailwind('text-gray-100')}>
                                    ...
                                    <View style={tailwind('flex flex-row items-center justify-between py-2 px-3')}>
                                        <View style={tailwind('flex-1')}>
                                            <Text style={tailwind('text-gray-100')}>{translate('Order.OrderScreen.Payload.Details.Currency')}</Text>
                                        </View>
                                        <View style={tailwind('flex-1 flex-col items-end')}>
